...
namespace MarchingCubesPlanet.TrianglePools
{
    ...
    public sealed class PlanetPlayerViewReference : MonoBehaviour
    {
        [Header("Sources")]
        ...
        {
            PlanetTrianglePoolRegistry.RegisterPlayerViewReference(this);
            ForcePush();
        }
        ...
        {
            PlanetTrianglePoolRegistry.UnregisterPlayerViewReference(this);
        }
        ...
        private void PushSnapshot(Vector3 positionWorld, Vector3 forwardWorld)
        {
            ...
            hasPushed = true;
            pushVersion++;
            PlanetTrianglePoolRegistry.PushPlayerView(this, lastPushedPositionWorld, lastPushedForwardWorld, pushVersion);
        }
